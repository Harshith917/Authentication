...
const ResetPassword = () => {
  ...
  // This component is a placeholder for the Reset Password page
  // You can implement the reset password functionality here;
...
const onSubmitNewPassword = async(e) =>{
  ...
  try {
    ...
    if(data.success){
      ...
      toast.error(data.message); // Show error message if reset fails
    }
  } catch (error) {
